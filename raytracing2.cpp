// Raytracer!
/*
Copyright (c) 2011,2016 Joel Yliluoma (http://iki.fi/bisqwit/)
May be distributed under the terms of license: CC-BY-SA 3.0
Featured on https://youtu.be/N8elxpSu9pw

Compilation instructions (requires libgd-dev):
g++ trace_test.cc -Wall -Wextra -Ofast -fopenmp -march=native \
